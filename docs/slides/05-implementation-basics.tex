...
\begin{lstlisting}[escapechar=!,basicstyle=\tt\tiny]
        .globl  go_0pl06.Many__args
        .type   go_0pl06.Many__args, @function
go_0pl06.Many__args:
.LFB0:
        .cfi_startproc
        cmpq    %fs:112, %rsp
...
.L3:
        ...
        .cfi_endproc
.LFE0:
        .size   go_0pl06.Many__args, .-go_0pl06.Many__args
        .globl  go.pl06..types    
\end{lstlisting}
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \item []
\begin{lstlisting}[escapechar=!,basicstyle=\tt\tiny]
    !{\hai{\tt .globl  go\_0pl06.Many\_\_args}}!
    !{\hai{\tt .type   go\_0pl06.Many\_\_args, ...}}!
!{\ao{\tt go\_0pl06.Many\_\_args:}}!
!{\ao{\tt .LFB0:}}!
...
!{\ao{\tt .L3:}}!
    ...
    !{\hai{\tt .cfi\_endproc}}!
!{\ao{\tt .LFE0:}}!
    !{\hai{\tt .size   go\_0pl06.Many\_\_args, ...}}!
...
\end{lstlisting}
\item \aka{\it syntax and operand order actually depend on the assembler}
\end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item ex.
    ...
    \item \ao{\tt leaq 4(\%rdi),\%rax} : {\tt \%rax = \%rdi + 4};
      this instruction looks like reading/writing memory, but
      it is actually just a peculiar arithmetic (common in address calculation)
    \end{itemize}
  \end{itemize}
\end{frame}
