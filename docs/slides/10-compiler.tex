...
\ifen
\begin{frame}
  \frametitle{ABI (What happens upon function calls?)}
  \begin{itemize}
  \item {\tt long f() \{ ... g(1,2,3,4,5,6,7,8); ... \}}
  \item
    \only<1>{during {\tt f}}%
...
\begin{frame}
  ...
  \begin{itemize}
  \item AST : data structure representing the program
  \item IR : common representation portable across multiple source/target languages
  \end{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item first write a {\it grammar}, typically in the BNF notation
